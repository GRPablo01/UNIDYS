...
import { JeuPuzzle } from "../../../composant/share/page-JEUX/jeu-puzzle/jeu-puzzle";



@Component({
  selector: 'app-jeu-puzzle1',
  standalone: true,
  imports: [
    CommonModule,
    HttpClientModule,
  ...
  templateUrl: './jeu-puzzle1.html',
  styleUrls: ['./jeu-puzzle1.css'],
})
export class JeuPuzzle1 implements OnInit {
