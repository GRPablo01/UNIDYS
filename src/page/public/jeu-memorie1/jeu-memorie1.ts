...
import { JeuMemorie } from '../../../composant/share/page-JEUX/jeu-memorie/jeu-memorie';



@Component({
  selector: 'app-jeu-memorie1',
  standalone: true,
  imports: [
    CommonModule,
    HttpClientModule,
  ...
  templateUrl: './jeu-memorie1.html',
  styleUrls: ['./jeu-memorie1.css'],
})
export class JeuMemorie1 implements OnInit {
