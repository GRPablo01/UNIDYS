...
import { JeuQcm } from "../../../composant/share/page-JEUX/jeu-qcm/jeu-qcm";



@Component({
  selector: 'app-jeu-qcm1',
  standalone: true,
  imports: [
    CommonModule,
    HttpClientModule,
  ...
  templateUrl: './jeu-qcm1.html',
  styleUrls: ['./jeu-qcm1.css'],
})
export class JeuQcm1 implements OnInit {
