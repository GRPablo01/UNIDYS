...
import { CreerJeux2 } from '../../../composant/share/page-CREERJEUX/creer-jeux2/creer-jeux2';



@Component({
  selector: 'app-creer-jeux',
  standalone: true,
  imports: [
    CommonModule,
    HttpClientModule,
  ...
  templateUrl: './creer-jeux.html',
  styleUrls: ['./creer-jeux.css'],
})
export class CreerJeux implements OnInit {
  ...
  ngOnInit(): void {
    // 🧠 Titre de la page
    this.titleService.setTitle('UNIDYS | Créer Jeux');
